...
public class SearchBook {
	...
	public ArrayList<String> doSearchBook(String s) {
		...
		//<tr><td>1</td><td><a href=/cgi-win/tcgid.exe?s557r50>大学英语四级考试题集 [汇编]／邢贵,韩志明主编</a></td><td>1995.3</td><td>H31-44/9503</td>
	...
	public String idToFloor(String id){
		...
		if ("ABCDEFGH".indexOf(idStart)!=-1) result = "三楼电梯旁";
		else if ("IJK".indexOf(idStart)!=-1) result = "四楼电梯旁";
		else if ("R".indexOf(idStart)!=-1) result = "五楼电梯旁";
		else if ("LMNOPQSTUVWXYZ".indexOf(idStart)!=-1) result = "五楼左边";
		else result = "-";
		if (result == oldStr) return "↑";
		oldStr = result;
		return result;
	}
