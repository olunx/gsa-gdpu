...
public class NewsUnionCompo extends Composite {

	private Table listTable;
	private static Listener mySetDataListener = null;
	private Button updateBut;
	// 保存数据的文件
	String fileName = "newsunion.xml";
	 ...
	 * @param style
	 */
	public NewsUnionCompo(Composite parent, int style) {
		super(parent, style);
		...
		updateBut.setImage(SWTResourceManager.getImage(NewsUnionCompo.class, "/cn/imgdpu/ico/refresh.gif"));
		...
		warnLab.setImage(SWTResourceManager.getImage(NewsUnionCompo.class, "/cn/imgdpu/ico/warning_obj.gif"));
		...
		warnLab.setText("所有数据均来源于[广药学生社团联合会网站]！小贴士：双击选中项浏览详细内容！O(∩_∩)O");

		CLabel label;
		label = new CLabel(this, SWT.NONE);
		label.setImage(SWTResourceManager.getImage(NewsUnionCompo.class, "/cn/imgdpu/ico/template_obj.gif"));
