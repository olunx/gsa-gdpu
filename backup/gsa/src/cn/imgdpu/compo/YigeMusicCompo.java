...
public class YigeMusicCompo extends Composite {
	 ...
	 * @param style
	 */
	public YigeMusicCompo(Composite parent, int style) {
		super(parent, style);
		...
		loadBut.setImage(SWTResourceManager.getImage(YigeMusicCompo.class, "/cn/imgdpu/ico/icon.gif"));
		...
		disBut.setImage(SWTResourceManager.getImage(YigeMusicCompo.class, "/cn/imgdpu/ico/delete_layout.gif"));
